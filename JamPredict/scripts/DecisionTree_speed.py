...
def main():
    ...
    if CACHEDATA and os.path.exists(f2name):
        ...
        if os.path.exists(fname) and CACHEDATA:
            ...
            X_train, Y_train, X_test, Y_test, mmn, external_dim, timestamp_train, timestamp_test, noConditionRegions, x_num, y_num, z_num = Data.loadDataFromRaw(
                ...
                , len_test=len_test, maxMinNormalization=is_mmn, preprocess_name=pkl_fname,
    ...
    if grid_cv:
        ...
        grid = GridSearchCV(estimator=DecisionTreeRegressor(random_state=random_state), scoring="neg_mean_squared_error",
